...
public class Tangent extends Operation{
    private OperationProperties myProperties = new OperationProperties(new String[]{"tan"}, 1);
    ...
    public Tangent (String command, List<Expression> operands) {
        myCommand = command;
        myOperands = operands;
    }
