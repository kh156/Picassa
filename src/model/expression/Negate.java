...
private OperationProperties myProperties = new OperationProperties(new String[]{"neg", "!"}, 1);
    ...
    public Negate (String command, List<Expression> operands) {
        myCommand = command;
        myOperands = operands;
    }
